...
const checklist = [
  "Tư vấn nhóm dịch vụ phù hợp",
  "Làm rõ scope trước khi báo giá",
  "Có thể hỗ trợ doanh nghiệp hoặc agency",
  "Tập trung triển khai rõ ràng, không cam kết quá đà",
];
...
export default function ServicesCTA() {
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const subject = encodeURIComponent(
      `Brief dịch vụ từ website T2M - ${company || name}`
    );
            ...
            <div className="relative p-6 sm:p-8 lg:p-10">
              ...
              <div className="relative">
                ...
                <p className="mt-5 max-w-xl text-base leading-8 text-slate-600">
                  ...
                  động liên hệ lại để tư vấn nhóm dịch vụ, phạm vi công việc và
                ...
                <div className="mt-8 grid gap-3 sm:grid-cols-3">
                  <div className="rounded-2xl border border-blue-100 bg-white/80 p-4 shadow-sm">
                    ...
                    <p className="mt-1 text-xs leading-5 text-slate-500">
                      Mô tả nhanh campaign cần hỗ trợ.
                    </p>
                  </div>
