        ...
        <div className="grid items-center gap-12 lg:grid-cols-[0.95fr_1.05fr]">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-slate-600 sm:text-lg">
              Một số dự án tiêu biểu T2M từng hỗ trợ triển khai theo hướng
              social activation, seeding, amplification, campaign operation và
              reporting. Các thông tin được trình bày gọn để đảm bảo tính bảo mật.
            </p>
