        ...
        <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
          <div>
            ...
            <p className="mt-5 max-w-xl text-base leading-8 text-slate-600 sm:text-lg">
              Một số đối tác, agency và đơn vị T2M từng đồng hành hỗ trợ triển
              khai campaign. Phần này hiển thị bằng text card để đảm bảo đồng bộ,
              không phụ thuộc chất lượng logo.
            </p>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-600">
                    T2M có thể làm việc như partner triển khai, hỗ trợ agency
                    hoặc đồng hành trực tiếp cùng brand theo từng campaign.
                  </p>
                </div>
              </div>
            </div>
