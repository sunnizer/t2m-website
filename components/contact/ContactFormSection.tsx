...
const checklist = [
  "T2M xem brief trước khi tư vấn",
  "Làm rõ scope và output cần có",
  "Tư vấn theo mục tiêu thực tế",
  "Có thể hỗ trợ doanh nghiệp hoặc agency",
];
...
export default function ContactFormSection() {
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const subject = encodeURIComponent(
      `Brief mới từ website T2M - ${company || name}`
    );
            ...
            <div className="relative p-6 sm:p-8 lg:p-10">
              ...
              <div className="relative">
                ...
                <p className="mt-5 max-w-xl text-base leading-8 text-slate-600">
                  Form này giúp T2M nắm nhanh nhu cầu ban đầu. Anh/chị chưa cần
                  brief quá chi tiết, chỉ cần mô tả mục tiêu hoặc vấn đề đang cần
                  hỗ trợ.
                </p>
                ...
                <div className="mt-8 grid gap-3 sm:grid-cols-3">
                  <div className="rounded-2xl border border-blue-100 bg-white/80 p-4 shadow-sm">
                    ...
                    <p className="mt-1 text-xs leading-5 text-slate-500">
                      Cho campaign đã có nhu cầu sơ bộ.
                    </p>
                  </div>
            ...
            <div className="border-t border-blue-100 bg-white/80 p-6 backdrop-blur sm:p-8 lg:border-l lg:border-t-0 lg:p-10">
              <form onSubmit={handleSubmit} className="grid gap-4">
                ...
                <div>
                  ...
                  <input
                    name="timeline"
                    placeholder="VD: Tháng 7, Q3, cần triển khai trong 2 tuần..."
                    className="h-12 w-full rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-blue-500 focus:ring-4 focus:ring-blue-100"
                  />
                </div>
